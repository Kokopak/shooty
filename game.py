...
b = base.Base(img=config.IMG_BASE, x=config.WIDTH/2, y=config.IMG_BASE.height * config.SCALE, scale=config.SCALE)
g = gun.Gun(img=config.IMG_GUN, x=b.x, y=b.height/8, scale=config.SCALE)
...
# Ajout un ennemi toutes les 5 sec
